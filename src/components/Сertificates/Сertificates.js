    ...
    <div className='certificates'>
      <div className='certificates__columns'>
        <div className='certificates__column_left'>
          ...
          <br></br>
          <p className='p certificates__info'>
            С подарочным сертификатом от River Flow у вашего близкого человека
            будет возможность испытать незабываемые впечатления и попробовать
            ...
            аренду лодок и речные прогулки.
          </p>
          <br></br>
          <p className='p certificates__info'>

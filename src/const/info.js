...
const faq = [
  {
    ...
    description: "Нет, мы приветствуем любой уровень мастерства и предоставляем инструктаж для новичков.",
  },
  {
    title: "Каков минимальный возраст для участия в водных развлечениях?",
    description: "Минимальный возраст - 8 лет. В целях безопасности дети младше 18 лет должны присутствовать в присутствии родителей или законных опекунов.",
  },
  {
    title: "Могу ли я принести свое собственное оборудование?",
    description: "Да, вы можете принести свой вейкборд, водные лыжи или доску для вейксерфинга. Однако если у вас нет собственного оборудования, мы предоставим его Вам.",
  },
  {
    title: "Обязательно бронировать?",
    description: "Мы настоятельно рекомендуем бронировать места заранее, чтобы убедиться в наличии свободных мест. Вы можете забронировать номер онлайн или позвонив нам.",
  },
  {
    title: "Могу ли я принести свою еду и напитки?",
    description: "Да, вы можете приносить свою еду и напитки. На наших лодках есть охладители, и мы просим вас убирать за собой.",
  },
  {
    title: "Есть ли скидки?",
    description: "Да, мы предлагаем 10% скидку для бронирования свыше 3х часов. Для посуточного бронирования производится индивидуальный расчет. Свяжитесь с нами для получения дополнительной информации.",
  },
  {
    title: "Можно ли доставить катер за город?",
    description: "Да, мы всегда готовы помочь организовать мероприятие за городом. Пожалуйста, свяжитесь с нами для получения дополнительной информации.",
  },
  {
    title: "Каковы ваши правила отмены бронирования?",
    description: "На все мероприятия действует 24-часовая отмена. Если вы отмените заказ менее чем за 24 часа до начала запланированного мероприятия, то предоплата не будет возвращена.",
  },
];


export { wakesurfInfo, panels, wakeboardInfo, walksInfo, faq };
